  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-6 right-6 z-[60] w-12 h-12 rounded-2xl bg-slate-900 text-white shadow-xl flex items-center justify-center border border-slate-700 active:scale-95 transition-all"
      >
      ...
      <aside className={`w-72 bg-[#0a0f1d] text-slate-300 fixed left-0 top-0 h-full flex flex-col shadow-2xl z-[55] border-r border-slate-800/50 transition-transform duration-500 ease-in-out lg:translate-x-0 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
        ...
        <div className="p-6 relative z-10 mt-auto">
          <div className="bg-slate-800/50 rounded-2xl p-4 border border-slate-700/50 flex items-center gap-4 hover:bg-slate-800 transition-colors cursor-pointer group">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold shadow-sm ring-2 ring-slate-700 group-hover:ring-blue-500 transition-all">
              AD
            </div>
